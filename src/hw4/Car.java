...
public class Car extends Vehicle {
	...
	public String toString() {
		return "Car [brand=" + brand + ", make=" + make + ", currentYear=" + currentYear + ", modelYear=" + modelYear
    ...
    public String toCSVString() {
        return String.format("Car,%s,%s,%d,%.2f,%s,%s,%.2f,%.2f,%d,%.2f,%s",
	...
	public double calculateMaintenanceCost(double distance) {
		...
		maintenanceCost = distance * super.mass * (currentYear-modelYear)*cylinders*0.0005;
